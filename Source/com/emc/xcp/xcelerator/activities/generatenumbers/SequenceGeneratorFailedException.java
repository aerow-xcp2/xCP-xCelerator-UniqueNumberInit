...
/**
 * Signals that a number could not be generated. 
 * 
 * Copyright (c) 1994 - 2010. EMC Corporation. All Rights Reserved.
 */
public class SequenceGeneratorFailedException extends DfException {

	private static final long	serialVersionUID	= -7613465958180061255L;

	/**
	 * Constructs an instance of SequenceGeneratorFailedException with null as
	 * its detail message and no cause.
	 */
	public SequenceGeneratorFailedException() {
		// NOP.
	}

	/**
	 * Constructs an instance of SequenceGeneratorFailedException with the
	 ...
	 *            the detail message
	 */
	public SequenceGeneratorFailedException(final String message) {
		super(message);
	}
	 ...
	 *            the cause
	 */
	public SequenceGeneratorFailedException(final String message, final Throwable cause) {
		super(message, cause);
	}
	 ...
	 *            the cause
	 */
	public SequenceGeneratorFailedException(final Throwable cause) {
		super(cause);
	}
}
